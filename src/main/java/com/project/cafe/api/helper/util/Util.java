...
import com.project.cafe.api.helper.constant.ConstantsRest;
...
public class Util {
  ...
  public static Query paginateResults(Query query, Map<String, String> params) {
    if (query != null && params != null && !params.isEmpty()) {
      ...
      boolean flagCount =
        StringUtils.isNotBlank(count) && Util.isNumeric(count);
  ...
  public static String formatCurrencyBigDecimal(
